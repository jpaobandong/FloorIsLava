...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
		...
		private void OnTriggerEnter(Collider other)
		{
			...
			{
				int currLev = SceneManager.GetActiveScene().buildIndex;
				if(currLev != 3)
                {
			...
			if (other.gameObject.layer == 9)
			{
				...
				{
					isBase = false;
					SkinnedMeshRenderer EthanBody = GetComponentInChildren<SkinnedMeshRenderer>();
					EthanBody.material = powerUpMaterial;
					powerUpDuration = 10f;
					m_JumpPower = m_JumpPower + additive;
					m_MoveSpeedMultiplier = m_MoveSpeedMultiplier + additive;
		...
		private void Update()
		{
			...
			else
			{
				if (!isBase)
				{
					isBase = true;
					SkinnedMeshRenderer EthanBody = GetComponentInChildren<SkinnedMeshRenderer>();
					EthanBody.material = baseMaterial;
					powerUpDuration = 10f;
					m_JumpPower = m_JumpPower - additive;
					m_MoveSpeedMultiplier = m_MoveSpeedMultiplier - additive;
				}
